import 'dart:async';
import 'dart:convert';
import 'package:flutter_app/models/chat_message.dart';
import 'package:http/http.dart' as http;

class ChatService {
  /// FIXME: Replace with your API key. IMPORTANT: In production, do NOT hardcode your API key. Use secure storage or environment variables instead. For example, run Flutter with `--dart-define=OPENAI_API_KEY=...` and access it with `String.fromEnvironment('OPENAI_API_KEY')` like this:
  /// ```dart
