...
class _NewExpenseState extends State<NewExpense> {
  ...
  void _presentDatePicker() async {
    ...
    setState(() {
      ...
      dateInvalid = pickedDate == null; // Added Date Valid Check
    });
  }

  // Title Validation
  String? validateTitle(String? title){
    final trimmedString = title?.trim() ?? '';

    if(trimmedString.isEmpty) return "Please enter a title";
    if(trimmedString.length > 50) return "Title must be 50 characters or less.";
    return null;
  }
  ...
  // Boxes for Title and Decoration
