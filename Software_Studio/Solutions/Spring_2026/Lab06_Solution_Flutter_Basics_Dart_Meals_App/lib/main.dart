  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        // hint: maybe add the filtered_meals_notifier here? AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
        ChangeNotifierProxyProvider2<List<Meal>, FiltersNotifier, FilteredMealsNotifier>(
          create: (_) => FilteredMealsNotifier(),
          update: (_, allMeals, filtersNotifier, filteredMealsNotifier) => filteredMealsNotifier!..update(allMeals, filtersNotifier.filters),
        ),
      ],
      child: const App(),
    ),
