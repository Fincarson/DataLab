...
```
-Djava.util.logging.config.file=core-patch/target/classes/java/util/logging/logging.properties
-Dorg.vanilladb.core.config.file=core-patch/target/classes/org/vanilladb/core/vanilladb.properties
```
...
```
-Djava.util.logging.config.file=bench/target/classes/java/util/logging/logging.properties
-Dorg.vanilladb.bench.config.file=bench/target/classes/org/vanilladb/bench/vanillabench.properties
-Dorg.vanilladb.core.config.file=bench/target/classes/org/vanilladb/core/vanilladb.properties
```
