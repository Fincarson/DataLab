...
**Note**: If you encounter `LockAbortException` during your experiments after you implement **UpdateItemPriceTxn**. Please refer to [this article](https://shwu10.cs.nthu.edu.tw/courses/databases/2026-spring/faq/-/blob/master/Lock_Abort_Exception_in_Benchmark.md) in FAQ repository.
...
- Experiments
	...
	- Note: If you are using Windows, you should **turn off** disk write cache feature for correctness. You can find more information [here](https://shwu10.cs.nthu.edu.tw/courses/databases/2026-spring/faq/-/blob/master/Windows_Disk_Write_Cache.md).
...
1. Fork our [Assignment 2](https://shwu10.cs.nthu.edu.tw/courses/databases/2026-spring/hw2) on GitLab
...
5. If you encounter any problem, take a look at our [FAQ repository](https://shwu10.cs.nthu.edu.tw/courses/databases/2026-spring/faq) first.


## Deadline

### Phase 1 
Submit your work before **2026/3/25 (Wed.) 23:59:59**.

### Phase 2 
Submit your work before **2026/4/01 (Wed.) 23:59:59**.
